...
/**
 * TitlesView is a view model class to contain the presentation data for display on the Titles.JSP. 
 * For each title, the TitlesView contains the Title, the lead and coordinator, the status, and if the a boolean tracking if the user logged
 * in is assigned to this title.
 * 
 * @author Mason
 * @version 1.0
 */
public class TitlesView {
    ...
    /**
     * The state tracking if the user logged in is assigned to this title.
     * True if the user is assigned. Otherwise, false.
     */
     ...
     * 
     * If the user is a freelancer, The status is directly associated with that users status on the Title.
     * If the user is a Design Lead, The status reflects the state of the Title across all Freelancers assigned to this title. If any freelancer
     * status is not ongoing, Then the status description should be "Requires Attention".
     * 
     * If the user is a Coordinator, The status is ongoing until the title has been posted to management. 
     */
     ...
     * @param isAssigned Boolean defining if the user viewing the page is currently assigned to the Title.
     * @param status The Status for the user viewing the page for this specific Title.
     * @throws InvalidTitlesViewException  Thrown when the title does not have all the required information to be presented.
     */
    ...
    /**
     * Access method to get check if the viewing user is assigned to this TItleView.
    ...
    /**
     * Mutator method to set the isAssigned status for this TitleView for this user.
