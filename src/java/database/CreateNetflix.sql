...
-- -----------------------------------------------------
-- Table `NetflixDB`.`USER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `NetflixDB`.`USER` ;

CREATE TABLE IF NOT EXISTS `NetflixDB`.`USER` (
...
CREATE TABLE IF NOT EXISTS `NetflixDB`.`USER_LANGUAGE` (
  ...
  CONSTRAINT `user_id`
    FOREIGN KEY (`user_id`)
    REFERENCES `NetflixDB`.`USER` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `NetflixDB`.`USER_SKILLSET` (
  ...
  PRIMARY KEY (`skillset_id`, `user_id`),
...
CREATE TABLE IF NOT EXISTS `NetflixDB`.`USER_MESSAGE_GROUP` (
  ...
  PRIMARY KEY (`user_id`, `message_group_id`),
...
CREATE TABLE IF NOT EXISTS `NetflixDB`.`ARTWORK_STYLE` (
  ...
  PRIMARY KEY (`style_id`, `artwork_id`),
...
CREATE TABLE IF NOT EXISTS `NetflixDB`.`ROUND` (
  ...
  PRIMARY KEY (`round_id`, `artwork_id`),
