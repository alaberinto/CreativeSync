...
<nav id="nav" class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
    <div class="container">
        ...
        <div id="navbarNav" class="collapse navbar-collapse">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="Titles">Titles</a></li>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Users">Users</a></li>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Messager">Messaging</a></li>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Reports">Reports</a></li>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Login">Logout</a></li>
                </li>
            </ul>
        </div>
    </div>
